...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<LuggageEntity>> LUGGAGE =
    ...
    public static final RegistryObject<EntityType<MiniMeEntity>> MINI_ME =
            ENTITY_TYPES.register("mini_me", () -> EntityType.Builder
                    .of(MiniMeEntity::new, MobCategory.CREATURE)
                    .sized(0.3F, 0.9F)
                    .clientTrackingRange(10)
                    .build("openblocks_reborn:mini_me"));
    public static final RegistryObject<EntityType<GlyphEntity>> GLYPH =
    ...
    public static final RegistryObject<EntityType<HangGliderEntity>> HANG_GLIDER =
    ...
    public static final RegistryObject<EntityType<GoldenEyeEntity>> GOLDEN_EYE =
    ...
    public static final RegistryObject<EntityType<CraneCarriedBlockEntity>> CRANE_CARRIED_BLOCK =
