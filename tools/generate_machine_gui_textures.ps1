...
# Render a large canonical instance of the previous containerPanel() renderer.
# Its 248px repeatable centre is larger than every current machine panel, so
# GuiGraphics needs only the nine border/centre slices instead of tens of
# thousands of 1px repeated tiles.
...
# Large canonical instances likewise keep recessed fields and bevel frames at
# no more than nine texture slices each.
